...
*/
 ...
 echo "<h1 style='text-align:center;color:red;'>Correction exercice</h1><hr>";
 ...
 class Commande 
 {
   ...
   // Dans ce constructeur je lui passe un objet de type Client.C'est-à-dire que je lui passe une instance de la classe Client.On a fait du type hinting.
   ...
   {
      // On ajoute l'article au tableau des articles commandés.articles[] = $a Pour ajouter un élément à un tableau on utilise la syntaxe suivante : $tableau[] = $element;
      $this->articles[] = $a;
   }
...
$article1 = new Article("T-shirt", 15.99, "T-shirt en coton", 10);
$article2 = new Article("Pantalon", 29.99, "Pantalon en lin", 5);
$article3 = new Article("Chaussures", 49.99, "Chaussures en cuir", 2);

$client1 = new Client("Bob", "1 rue de la Paix", "bob@bob.com");
...
echo "Le client " . $commande1->getClient()->getNom() . " a commandé " . count($commande1->getArticles()) . " articles pour un montant total de " . $commande1->calculerTotal() . " euros.";

echo "<hr>";

$client2 = new Client("Alice", "2 rue de la Paix", "alice@gmail.com");

$commande2 = new Commande($client2);

$commande2->ajouterArticle($article1);

echo "Le client " . $commande2->getClient()->getNom() . " a commandé " . count($commande2->getArticles()) . " articles pour un montant total de " . $commande2->calculerTotal() . " euros.";