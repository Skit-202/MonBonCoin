...
3. Créez une classe abstraite appelée `Figure` qui implémente l'interface `Forme` et utilise le trait `Affichage`. 
...
trait Affichage
{
    public function afficherInformations()
    {
        ...
        echo 'Périmètre : ' . $this->calculerPerimetre() . '<br>';
        echo 'Surface : ' . $this->calculerSurface() . '<br>';
    }
}
...
abstract class Figure implements Forme
{
    ...
    final public function finaliser()
    {
        echo 'La figure est finalisée et ne peut être modifiée.';
    }
}
